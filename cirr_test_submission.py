...
if __name__ == '__main__':
    ...
    testset = datasets.CIRR(path='', transform='')
    ...
    test_cirr_submit_result(model, save_dir=save_dir, testset=testset, name='', batch_size=32)
